                            ...
                            @forelse($students as $student)
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-6 py-2 text-center ">
                                        <form
                                            action="{{ route('student.update-status', $student->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('PATCH')
                                            <label class="inline-flex items-center cursor-pointer">
                                                <input type="checkbox" value="" class="sr-only peer"
                                                       onchange="this.form.submit()" {{ $student->status == 1 ? 'checked' : '' }}>
                                                <div
                                    ...
                                    <td class="px-6 py-2 flex justify-center gap-3">
                                        @include('admin.partials.student.action')
...
{{--                        {{ $students->links() }}--}}
        ...
        {{-- Add: Modal --}}
        @include('admin.partials.student.create')
