        ...
        <div class="p-2 sm:ml-64">
            <div class="bg-gray-200 m-8 rounded-lg">
                <div class="px-1 pt-4 rounded-lg flex items-center justify-between">
                    ...
                    <a href="{{ url()->previous() }}" class="inline-flex items-center justify-center px-3 py-1 mr-3 text-sm
                ...
                <div class="p-4 rounded-lg">
                    <form
                        ...
                        justify-center px-3 py-1 text-sm font-medium text-center
                        text-white rounded-md bg-green-500 hover:bg-green-700">
                                Create
