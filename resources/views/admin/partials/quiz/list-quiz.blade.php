...
@section('content')
    ...
    <main>
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                            ...
                            @forelse($quizzes as $quiz)
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-6 py-2 min-w-32 max-w-32 text-center">
                                        {{ \Carbon\Carbon::parse($quiz->quiz_date)->format('M d, Y') ?? '' }}
                                    </td>
                                    <td class="px-6 py-2 min-w-1 max-w-1 text-center">
                                        {{ $quiz->quiz_duration ?? '' }} mins
                                    </td>
                                    ...
                                    <td class="px-6 py-2 flex justify-center gap-3">
                                        @include('admin.partials.quiz.action')
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="7" class="px-6 py-2 text-center bg-white">
                                        No data found.
                                    </td>
                                </tr>
                            @endforelse
        ...
        {{-- Add: Modal --}}
        @include('admin.partials.quiz.create')
